...
def again():    # second main part
    print("-"*20)
    global start_ender
    start_ender = False # stops first part from starting after this point
...
while True: # repeat if not entered second part
    if start_ender:
        start() # repeat first part if second part didnt start
    else:
        break